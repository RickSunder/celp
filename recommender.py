...
# def similarity(mat, id1):
#     similarity_matrix = pd.DataFrame(mat, index = mat.index, columns = mat.index)
#     business_ids = similarity_matrix.index
#     for business2 in business_ids:
#         feature1 = mat[(mat.index == id1)]['attributes'].item()
#         feature2 = mat[(mat.index == business2)]['attributes'].item()
#         bag = []
...
#         if business2 == id1:
#             similarity_matrix.loc[id1][business2] = 0
#         similarity_matrix.loc[id1][business2] = similar/total_words

        
#     pprint(similarity_matrix)
#     temp = similarity_matrix.tolist()
#     top_recommends = temp.sort()[10]
#     return top_recommends
    

# def sim_matrix(mat, id):
...
# def sim_matrix(mat, business):
#     similarity_matrix = pd.DataFrame(mat, index = mat.index, columns = mat.index)
#     business_ids = mat.index
#     for business2 in business_ids:
#         similarity_matrix.loc[business][business2] = (attribute_similarity(mat, business, business2) * categories_similarity(mat, business, business2)) 
#         if business2 == business:
#             similarity_matrix.loc[business][business2] = 0
#     return similarity_matrix

# def attribute_similarity(mat, id1, id2):
#     similar = 0
#     bag = []
#     feature1 = mat[(mat.index == id1)]['attributes'].item()
#     feature2 = mat[(mat.index == id2)]['attributes'].item()
...
# def categories_similarity(mat, id1, id2):
#     similar = 0
#     bag = []
#     feature1 = mat[(mat.index == id1)]['categories'].item()
#     feature2 = mat[(mat.index == id2)]['categories'].item()
